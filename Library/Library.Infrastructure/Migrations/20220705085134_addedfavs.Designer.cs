...
namespace Library.Infrastructure.Migrations
{
    ...
    [Migration("20220705085134_addedfavs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClientComicBook", b =>
                {
                    ...
                    b.HasKey("ClientsId", "ComicsId");

                    b.HasIndex("ComicsId");

                    b.ToTable("ClientComicBook");
                });
            ...
            modelBuilder.Entity("ClientComicBook", b =>
                {
                    b.HasOne("Library.Core.Client", null)
                        .WithMany()
                        .HasForeignKey("ClientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Library.Core.ComicBook", null)
                        .WithMany()
